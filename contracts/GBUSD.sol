...
contract GBUSD is ERC20, Ownable {
    ...
    // blacklisting from transactions
    ...
    constructor() ERC20("GORILLA BUSD", "$GBUSD") {
        marketingWallet = payable(0xBD926935AB9EE431fB490AAe7A2d63eC2787a574);
        devWallet = payable(0x8ee75446bB21d97d1279249533d16d2E4592652d);
